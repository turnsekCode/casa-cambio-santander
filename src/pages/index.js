...
const schema = {
  ...
  description:
    "¿Necesitas cambiar divisa en Santander? Visita nuestra casa de cambio y cambia moneda extranjera al momento y sin comisiones. Solo en Quickgold.",
  address: {
    "@type": "PostalAddress",
  ...
  return (
    <>
      <Head>
        ...
        ></script>
        <title>
          Casas de Cambio en Santander | Cambio de Divisas Santander
        </title>
        <meta
          name="description"
          content="¿Necesitas cambiar divisa en Santander? Visita nuestra casa de cambio y cambia moneda extranjera al momento y sin comisiones. Solo en Quickgold."
        />
