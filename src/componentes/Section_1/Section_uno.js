  ...
  return (
    <section className={styles.contenedorSectionUno}>
      <div className={styles.bloqueIzq}>
        <h1>
          Casas de cambio en <span className={styles.linea}>Santander</span>
        </h1>
        <p>
          Visita nuestro money exchange en Santander y cambia dólares por euros
          o cualquier otra moneda al instante. Consigue el mejor tipo de cambio
          en nuestra oficina de cambio en Santander.
        </p>
