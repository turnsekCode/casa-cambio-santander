    ...
    <section className={styles.contenedorSectionTres}>
      <div className={styles.contenedorContenidoUno}>
        <div className={styles.bloqueIzq}>
          ...
          <p>
            <span>
              Visita nuestra casa de cambio en Santander, estamos en calle
              Camino Alonso Vega número 2. Te esperamos para cambiar tu divisa y
              llevarte euros en efectivo y al instante.{" "}
            </span>
        ...
        <div className={styles.bloqueDer}>
          ...
          <p>
            Cambiar divisa en Quickgold Santander es muy sencillo. Visita
            nuestra casa de cambio, indícanos la divisa qué quieres cambiar y al
            momento podrás llevarte euros al mejor tipo de cambio en la capital
            de la región de Cantabria.
          </p>
        </div>
      </div>
      <h1>
        Cambiar divisa en <span className={styles.linea}>Santander</span> es muy
        fácil
      </h1>
